...
<html lang="en">
    <head>
        ...
        <title>Dashboard | Sofbox Style</title>
        <link
            rel="stylesheet"
       ...
       dark:bg-dark-component-bg dark:border-border-dark"
            ...
            <div class="h-full px-4 pb-6 overflow-y-auto flex flex-col justify-between">
              ...
              hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary group transition relative">
                       ...
                       w-6 h-6 text-xs font-medium text-white bg-gradient-primary rounded-full">
                                3
                            </span>
                        </a>
                    </li>
        ...
        <div class="p-4 sm:ml-64">
            <div class="p-4 rounded-lg mt-14">
                    ...
                    <div class="flex items-center space-x-4">
                        <div>
                            ...
                            <p class="mt-1 text-text-secondary dark:text-dark-text-secondary">
                                Menampilkan semua MoM yang ada di sistem.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    <div
                        class="flex items-center justify-between p-6 rounded-lg bg-component-bg dark:bg-dark-component-bg shadow-md transition-transform hover:scale-105">
                        <div>
                            <p class="text-3xl font-bold text-text-primary dark:text-dark-text-primary">115</p>
                            <p class="text-md text-text-secondary mt-1">Total MoM</p>
                        </div>
                        <div
                            class="flex items-center justify-center h-16 w-16 rounded-full bg-green-100 dark:bg-green-500/20">
                            <i class="fa-solid fa-box fa-xl text-green-500"></i>
                        </div>
                    </div>
                    <div
                        class="flex items-center justify-between p-6 rounded-lg bg-component-bg dark:bg-dark-component-bg shadow-md transition-transform hover:scale-105">
                        <div>
                            <p class="text-3xl font-bold text-text-primary dark:text-dark-text-primary">10</p>
                            <p class="text-md text-text-secondary mt-1">MoM Pending</p>
                        </div>
                        <div
                            class="flex items-center justify-center h-16 w-16 rounded-full bg-yellow-100 dark:bg-yellow-500/20">
