...
<div class="pt-2">
    ...
    <div class="space-y-6">
        ...
        <form id="filterForm" action="{{ route('admin.repository') }}" method="GET">
                ...
                <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
                    ...
                    <div class="md:col-span-2 relative">
                        <input type="text"
                               ...
                               placeholder="Cari berdasarkan judul atau proyek..."
                               class="w-full bg-gray-700 border-gray-600 text-white rounded-lg text-sm focus:ring-red-500 focus:border-red-500 pr-8">
                    ...
                    <div class="md:col-span-2 flex items-center gap-2">
                        <button type="submit" class="flex-1 flex justify-center items-center px-4 py-2 text-sm font-semibold text-white btn-neon-red rounded-lg">
...
<script>
    ...
    let searchTimeout = null; // Untuk auto-search delay
    ...
    // Auto-search function dengan delay
    function setupAutoSearch() {
        ...
        // Auto-search untuk input pencarian dengan delay 5 detik
        searchInput.addEventListener('input', function() {
            ...
            // Set timeout baru untuk 2 detik
        ...
        // Auto-submit untuk date filter (langsung submit)
        dateInput.addEventListener('change', function() {
            filterForm.submit();
        });

        // Auto-submit untuk status filter (langsung submit)
