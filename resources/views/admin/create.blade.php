...
<div class="pt-2">
    ...
    <div class="p-6 md:p-8 rounded-xl shadow-lg bg-gray-800 border-l-4 border-red-500 mb-6">
        <h1 class="text-3xl font-bold font-orbitron text-neon-red">Create New MoM (Admin)</h1>
        <p class="mt-1 text-gray-400">Buat notulensi rapat baru yang akan otomatis berstatus <strong class="text-green-400">Approved</strong>.</p>
    </div>
        ...
        <form id="mom-form" class="space-y-10">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div><label for="judul" class="block mb-2 text-sm font-medium text-gray-300">Judul Rapat</label><input type="text" name="title" id="judul" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required></div>
                    <div><label for="tempat" class="block mb-2 text-sm font-medium text-gray-300">Tempat</label><input type="text" name="location" id="tempat" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required></div>
                    <div><label for="pimpinan_rapat" class="block mb-2 text-sm font-medium text-gray-300">Pimpinan Rapat</label><input type="text" name="pimpinan_rapat" id="pimpinan_rapat" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required></div>
                    <div><label for="notulen" class="block mb-2 text-sm font-medium text-gray-300">Notulen</label><input type="text" name="notulen" id="notulen" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required></div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div><label for="tanggal" class="block mb-2 text-sm font-medium text-gray-300">Tanggal</label><input type="date" name="meeting_date" id="tanggal" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required></div>
                    <div><label for="waktu_mulai" class="block mb-2 text-sm font-medium text-gray-300">Waktu Mulai</label><input type="time" name="start_time" id="waktu_mulai" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required></div>
                    <div><label for="waktu_selesai" class="block mb-2 text-sm font-medium text-gray-300">Waktu Selesai</label><input type="time" name="end_time" id="waktu_selesai" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" required></div>
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <label class="block mb-2 text-sm font-medium text-gray-300">Peserta Rapat (Internal)</label>
                        <div class="flex gap-2">
                            <input type="text" id="input-internal-unit" class="bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-red-500 focus:border-red-500 block w-full p-2.5" placeholder="Nama Unit/Bagian...">
                            <button type="button" id="btn-add-internal-unit" class="px-5 py-2.5 text-sm font-semibold text-white btn-neon-red rounded-lg flex-shrink-0">Tambah</button>
                        </div>
                        <div id="list-internal-attendees-container" class="space-y-4 mt-4"></div>
                        <p class="mt-1 text-xs text-gray-500">Tambah Unit, lalu masukkan nama pesertanya.</p>
                    </div>
                     <div>
            ...
            <div class="space-y-6">
                ...
                <div id="list-mitra-container" class="space-y-4 mt-4"></div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">PNG, JPG, PDF, DOCX (MAX. 10MB). Dapat mengunggah lebih dari 1 file.</p>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        const submitForm = async () => {
            ...
            // Salin data form standar + Nama Pimpinan & Notulen Manual + Hidden Input Admin
            const simpleFields = ['title', 'location', 'meeting_date', 'start_time', 'end_time', 'pimpinan_rapat', 'notulen', 'is_admin_submission'];
