    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-component-bg border-r border-border-light sm:translate-x-0 dark:bg-dark-component-bg dark:border-border-dark" aria-label="Sidebar">
        <div class="h-full px-4 pb-6 overflow-y-auto flex flex-col justify-between">
            <ul class="space-y-2 font-medium">
                <li><a href="index" class="flex items-center p-3 rounded-lg bg-primary/20 text-primary font-semibold group"><i class="fa-solid fa-chart-pie w-5 h-5"></i><span class="ms-3">Dashboard</span></a></li>
                ...
                <li><a href="reminder" class="flex items-center p-3 rounded-lg text-text-secondary dark:text-dark-text-secondary hover:bg-primary/10 dark:hover:bg-primary/20 hover:text-primary group transition relative"><i class="fa-solid fa-bell w-5 h-5 group-hover:text-primary"></i><span class="ms-3">Reminder</span><span class="absolute right-3 inline-flex items-center justify-center w-6 h-6 text-xs font-medium text-white bg-red-500 rounded-full">3</span></a></li>
            ...
            <div class="flex flex-col md:flex-row items-center justify-between p-6 md:p-8 overflow-hidden rounded-lg shadow-md bg-component-bg dark:bg-dark-component-bg border-l-4 border-primary">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-text-secondary dark:text-dark-text-secondary">Selasa, 30 September 2025.</p>
                    </div>
                </div>
                <div class="flex space-x-2 mt-4 md:mt-0 w-full md:w-auto">
                    <a href="create" class="flex justify-center items-center px-4 py-2 text-sm font-semibold text-white bg-primary rounded-lg shadow-lg hover:bg-primary-dark transform transition-all duration-200 focus:ring-4 focus:ring-red-300 w-full">
