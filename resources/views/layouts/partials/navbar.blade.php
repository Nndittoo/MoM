        ...
        <div class="relative hidden md:block w-64 lg:w-96 mr-4">
          ...
          <div id="search-dropdown"
            ...
            <div id="search-results"
                 class="max-h-96 overflow-y-auto divide-y divide-border-light dark:divide-border-dark">
                ...
                item.innerHTML = `
                  <a href="/moms/${mom.version_id}" class="flex items-center space-x-3">
                    ...
                    <div class="flex-1 min-w-0">
                      <p class="text-sm font-medium text-text-primary dark:text-dark-text-primary truncate">${mom.title}</p>
                      <p class="text-xs text-text-secondary dark:text-dark-text-secondary">${createdDate}, ${createdTime}</p>
                    </div>
                  </a>`;
